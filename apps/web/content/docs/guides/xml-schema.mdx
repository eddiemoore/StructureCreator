...
This enables `{{if VAR}}...{{endif}}` conditionals and `{{for item in VAR}}...{{endfor}}` loops within file content. See the [Conditionals & Loops guide](/docs/guides/conditionals#file-content-templating) for full documentation.
