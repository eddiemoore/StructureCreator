...
1. **Write XML** - Enter XML directly in the left panel
...
For this guide, we'll write XML. Enter this schema in the left panel:
...
The center panel shows a tree preview of what will be created:
