import { asVariableName } from "./variableName";
/**
 * Variable transformation and substitution for the web Target.
 * Port of the Rust transforms.rs functionality. Lives in the shared package
 * so the pure Plan module (ADR-0004) can consume it without reaching into
 * apps/desktop; the web adapter re-exports it from its old location.
 */

import type { ValidationError, ValidationRule } from "./types";
